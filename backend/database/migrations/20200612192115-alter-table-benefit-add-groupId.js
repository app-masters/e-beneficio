...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
       ...
       *
       * After that, all the rows from the benefits table are updated, filling
       * the groupId field.
       */
      ...
      await queryInterface.removeColumn('Benefits', 'groupName', { transaction });
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.removeColumn('Benefits', 'groupId', { transaction });
